"""
Django settings for binance_trade project.
...
SECRET_KEY = os.environ.get("SECRET", "default_key_insecure")
...
ROOT_URLCONF = "binance_trade.urls"
...
WSGI_APPLICATION = "binance_trade.wsgi.application"

ASGI_APPLICATION = "binance_trade.asgi.application"
...
# MEDIA_URL = os.getenv("MINIO_ENDPOINT_URL") + '/'
MEDIA_URL = 'media/'
...
# AWS_S3_ENDPOINT_URL = os.getenv("MINIO_ENDPOINT_URL")  # MinIO Endpoint, e.g., "http://127.0.0.1:9000"
# AWS_S3_REGION_NAME = None  # MinIO does not require a region
# AWS_QUERYSTRING_AUTH = False  # Optional: Publicly accessible files
